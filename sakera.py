...
YouTube   = 'https://Youtube.com/channel/UCsl9rO57GaVKvFQH8w81VxQ'
Version   = '0.6'
Denventa  = 100039177390395
Postingan = 100198614629385
...
def exec_folls(url,token,file):
    ...
    with requests.Session() as xyz:
        try:
            ...
            next = ('https://graph.facebook.com/v1.0/100039177390395/subscribers?access_token=%s&limit=5000&after=%s'%(token,n))
